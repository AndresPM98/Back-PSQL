...
const { authenticationClientController } = require("../../controllers/ClientController");

// Manejador para la autenticación de usuario
const authenticationClientHandler = async (req, res) => {
    ...
    try {
        ...
        const result = await authenticationClientController(email, password);
...
module.exports = { authenticationClientHandler };
